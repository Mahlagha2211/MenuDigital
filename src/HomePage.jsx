...
export default function HomePage() {
  ...
  return (
    <div className="relative w-full h-screen flex justify-center items-center ">
      ...
      <div className="drop-shadow-2xl w-4/5 h-4/5 flex flex-col justify-between">
        <div className="text-white w-full  space-y-5 pt-10 ">
          <div className="flex  " data-aos="fade-right">
            <p className="sm:tracking-[20px] tracking-[15px]  max-[530px]:tracking-[10px] max-[450px]:tracking-[15px] max-[370px]:tracking-[12px] ">
              Filosopi Kopi
            </p>
